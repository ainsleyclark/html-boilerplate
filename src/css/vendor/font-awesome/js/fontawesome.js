...
(function() {
    ...
    function toHtml(abstractNodes) {
        var tag = abstractNodes.tag,
            ...
            attributes =
                _abstractNodes$attrib === undefined
                    ? {}
                    : _abstractNodes$attrib,
            _abstractNodes$childr = abstractNodes.children,
            children =
                _abstractNodes$childr === undefined
                    ? []
                ...
                .forEach(function(node) {
                    [":before", ":after"].forEach(function(pos) {
                        ...
                        var alreadyProcessedPseudoElement = children.filter(
                            function(c) {
                                return (
                                    c.getAttribute(DATA_FA_PSEUDO_ELEMENT) ===
                                    pos
                                );
                            }
                        )[0];
    ...
    var counter = function counter(content) {
        ...
        var _params$title3 = params.title,
            ...
            attributes =
                _params$attributes3 === undefined ? {} : _params$attributes3,
    ...
    var autoReplace = function autoReplace() {
        ...
        var _params$autoReplaceSv = params.autoReplaceSvgRoot,
            autoReplaceSvgRoot =
                _params$autoReplaceSv === undefined
                    ? DOCUMENT
